...
if (isset($_GET['action']) && $_GET['action'] === 'get_stats') {
    ...
    // 2. Fetch present students today
    $presentToday = 0;
    ...
    // 4. Prepare data for weekly chart
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header"><h5 class="modal-title" id="exampleModalLabel">Are you sure to Logout?</h5><button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button></div>
                <div class="modal-footer"><button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button><a class="btn btn-danger" href="index.php">Logout</a></div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            async function updateDashboardStats() {
                try {
                    // Fetch the latest data from our AJAX endpoint
                    ...
                    if (attendanceChart && data.chartData) {
                        ...
                        attendanceChart.update(); // This smoothly redraws the chart
                    }
            ...
            // Poll for new data every 3 seconds (3000 milliseconds).
            // You can change 3000 to 1500 to make it update even faster (every 1.5 seconds).
